...
export default function NotificationsPage() {
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="w-1/3 bg-gray-100 p-4 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <div className="w-2/3 p-4 rounded shadow-lg">
