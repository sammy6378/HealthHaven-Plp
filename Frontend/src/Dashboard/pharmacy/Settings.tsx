...
export default function Settings() {
  ...
  return (
    ...
    <div className="flex flex-col gap-5 md:flex-row p-6">
    ...
    <>
      ...
      <div className="pt-6 flex items-start justify-center">
        <div className="flex flex-col space-y-4 min-w-screen animated fadeIn faster">
          ...
          <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 text-start lg:items-center justify-between">
